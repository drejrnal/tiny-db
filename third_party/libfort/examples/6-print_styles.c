...
#define PRINT_TABLE_WITH_STYLE(style) print_table_with_style(style, #style)
...
void print_table_with_different_styles_in_tbl_format(void) {
  ...
  const wchar_t *style_names[] = {L"FT_BASIC_STYLE",       L"FT_BASIC2_STYLE", L"FT_SIMPLE_STYLE", L"FT_PLAIN_STYLE",
                                  L"FT_DOT_STYLE",         L"FT_EMPTY_STYLE",  L"FT_EMPTY2_STYLE", L"FT_SOLID_STYLE",
                                  L"FT_SOLID_ROUND_STYLE", L"FT_NICE_STYLE",   L"FT_DOUBLE_STYLE", L"FT_DOUBLE2_STYLE",
                                  L"FT_BOLD_STYLE",        L"FT_BOLD2_STYLE",  L"FT_FRAME_STYLE"};
